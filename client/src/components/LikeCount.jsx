...
const LikeCount = ({props}) => {
    ...
    const { data: blogLikeCount, loading, error } = useFetch(`${getEnv("VITE_API_BASE_URL")}/blog-like/get-like/${props.blogid}/${user && user.isLoggedIn ? user.user._id:'' }`,{
        ...
        // useEffect(() =>{
        //     if(blogLikeCount && typeof blogLikeCount.likecount !== 'undefined'){
        //         // only update when value changed to avoid extra rerenders
        //         setLikeCount(prev => {
        //             if (prev !== blogLikeCount.likecount) return blogLikeCount.likecount
        //             return prev
        //         })
        //     }
        // }, [blogLikeCount])
